...
#logging.basicConfig(filename='invalid_links_v10.log', level=logging.WARNING, format='%(asctime)s - %(levelname)s - %(message)s')
...
info_handler = logging.FileHandler('successful_updates_sribu_22_2.log')
info_handler.setLevel(logging.INFO)
info_formatter = logging.Formatter('%(asctime)s - %(levelname)s - %(message)s')
info_handler.setFormatter(info_formatter)

# Error handler for errors and warnings
error_handler = logging.FileHandler('errors_sribu_22_2.log')
...
def replace_url_prefix(url):
    ...
    replacement = 'https://prod-sribu-additional.sniag.upcloudobjects.com/'
        ...
        while True:
            ...
            for row in rows:
                ...
                if new_value != old_value:
                    # print(new_value, old_value, id, table_name, column_name)
